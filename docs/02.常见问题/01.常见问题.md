...
Field userMapper in com.sinog2c.gkadmin.modules.system.service.impl.UserServiceImpl required a bean of type 'com.sinog2c.gkadmin.modules.system.service.mapper.UserMapper' that could not be found.
...
Consider defining a bean of type 'com.sinog2c.gkadmin.modules.system.service.mapper.UserMapper' in your configuration.
```
生成的实现类如下图

![image477c529cdc640f06.jpg](/gkadmin-doc/images/2020/07/07/image477c529cdc640f06.jpg)
...
## 关于系统如何放行部分接口
[匿名访问接口](https://gkadmin.vip/guide/hdsc.html#%E6%8E%A5%E5%8F%A3%E6%9D%83%E9%99%90)
...
请检查你新建的模块包名是不是 `com.sinog2c.gkadmin`

如果不是，那么需要在 system 模块中的 AppRun 中配置注解

```java
// com.demo.* 改为你自己定义的包名
@ComponentScan(basePackages ={"com.sinog2c.gkadmin","com.xxxxxxx"})
@EnableJpaRepositories({"com.xxxxxxx.**.repository","com.sinog2c.gkadmin.**.repository"})
@EntityScan({"com.xxxxxxx.*","com.sinog2c.gkadmin.*"})
```
...
使用如下代码即可, Issues地址：[https://github.com/elunez/gkadmin/issues/585](https://github.com/elunez/gkadmin/issues/585)
...
## 如何反馈项目 Bug
可在 [Issues](https://github.com/elunez/gkadmin-docs/issues) 中留言，或者加群```891137268、947578238、659622532```进行反馈
