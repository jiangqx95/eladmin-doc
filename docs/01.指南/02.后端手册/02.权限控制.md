...
![](/gkadmin-doc/images/2020/06/25/20200605134807.jpg)
...
![](/gkadmin-doc/images/2020/06/25/20200605142356.jpg)
...
**源码:**
``` java
// gkadmin-common -> com.sinog2c.gkadmin.config.ElPermissionConfig
@Service(value = "el")
...
**gkadmin-system -> modules -> security ->  config -> SecurityConfig**
